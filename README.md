...
This repository includes Ruby files for an Object-Oriented Programming (OOP) school library app. The app is structured using classes to model students, teachers, and a basic library system.
...
```
  git clone https://github.com/prg-04/OOP-school-library.git
...
To run the project, create a `main.rb` file and instantiate the class files in `main.rb` and execute the following command:
...
Contributions, [issues](https://github.com/prg-04/OOP-school-library/issues), and feature requests are welcome!
